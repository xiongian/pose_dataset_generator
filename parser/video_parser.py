...
VID_DIR = "C:\\Data\\SprinterData\\TrainingVideos"
...
def data_extractor(dir: str) -> list[tuple[torch.tensor, int]]:
    videos = sorted(os.listdir(dir), reverse=True)
    print(videos)
